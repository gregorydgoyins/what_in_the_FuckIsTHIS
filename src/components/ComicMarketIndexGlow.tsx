...
export function ComicMarketIndexGlow() {
  ...
  return (
    <div className="bg-slate-800/90 backdrop-blur-md rounded-xl p-6 shadow-xl w-full mb-6">
      ...
      {window.location.pathname === '/market-index' && (
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {infoOpen && (
              <div className="absolute right-0 top-full mt-2 w-72 bg-slate-700/90 backdrop-blur-md rounded-lg shadow-xl border border-slate-600/50 p-4 z-10 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-700/50 p-4 rounded-lg border border-slate-600/50 hover:shadow-[0_0_15px_rgba(255,255,0,0.7)] transition-all">
          ...
          <p className="text-xl font-bold text-indigo-400">+{((finalValue - initialValue) / initialValue * 100).toFixed(1)}%</p>
...
export default ComicMarketIndexGlow;